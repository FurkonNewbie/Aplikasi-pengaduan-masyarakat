@extends('page.admin', ['title' => 'profile'])
                ...
                <div class="col">
                    <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="{{ route('tampil_profile_admin') }}">Update profile</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('password_admin') }}">Update Password</a></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="/img/undraw_profile.svg" alt="avatar" class="rounded-circle img-fluid"
                                style="width: 150px;">
                            <h5 class="my-3">{{ $profileAdmin->nama }}</h5>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $profileAdmin->nama }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $profileAdmin->email }}</p>
                                </div>
                            </div>
                            <hr>
                            <div class="row">
                                ...
                                <div class="col-sm-9">
                                    <p class="text-muted mb-0">{{ $profileAdmin->no_telepon }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
