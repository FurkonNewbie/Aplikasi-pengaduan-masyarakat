...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul style="background-color: #004643;" class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="masyarakat.html">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="kategori-pengaduan.html">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">433</div>
                                                </div>
                                                <div class="col">
